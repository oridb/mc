...
echo 	ar	-rcs libsys.a ifreq.o syscall.o util.o setup.o syserrno.o systypes.o sys.o  && 	ar	-rcs libsys.a ifreq.o syscall.o util.o setup.o syserrno.o systypes.o sys.o  &&\
