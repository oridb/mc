...
echo 	$pwd/6/6.out	-I ../sys -I . `$pwd/sysselect.sh syswrap`;	$pwd/6/6.out	-I ../sys -I . `$pwd/sysselect.sh syswrap`
echo 	6a	-o memops-impl.6 `$pwd/sysselect.sh memops-impl`;	6a	-o memops-impl.6 `$pwd/sysselect.sh memops-impl`
