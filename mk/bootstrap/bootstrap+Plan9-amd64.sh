...
echo 	$pwd/6/6.out	`$pwd/sysselect.sh sys`;	$pwd/6/6.out	`$pwd/sysselect.sh sys`
echo 	$pwd/6/6.out	`$pwd/sysselect.sh ifreq`;	$pwd/6/6.out	`$pwd/sysselect.sh ifreq`
...
echo 	$pwd/6/6.out	-I ../sys -I . `$pwd/sysselect.sh syswrap`;	$pwd/6/6.out	-I ../sys -I . `$pwd/sysselect.sh syswrap`
...
echo 	$pwd/6/6.out	-I ../sys -I . `$pwd/sysselect.sh wait`;	$pwd/6/6.out	-I ../sys -I . `$pwd/sysselect.sh wait`
...
echo 	$pwd/6/6.out	-I ../sys -I . `$pwd/sysselect.sh errno`;	$pwd/6/6.out	-I ../sys -I . `$pwd/sysselect.sh errno`
...
echo 	$pwd/6/6.out	-I ../sys -I . `$pwd/sysselect.sh syswrap-ss`;	$pwd/6/6.out	-I ../sys -I . `$pwd/sysselect.sh syswrap-ss`
...
echo 	$pwd/6/6.out	-I ../sys -I . `$pwd/sysselect.sh env`;	$pwd/6/6.out	-I ../sys -I . `$pwd/sysselect.sh env`
echo 	$pwd/6/6.out	-I ../sys -I . `$pwd/sysselect.sh resolve`;	$pwd/6/6.out	-I ../sys -I . `$pwd/sysselect.sh resolve`
...
echo 	$pwd/6/6.out	-I $pwd/lib/regex -I $pwd/lib/bio -I $pwd/lib/std -I $pwd/lib/sys `$pwd/sysselect.sh config`;	$pwd/6/6.out	-I $pwd/lib/regex -I $pwd/lib/bio -I $pwd/lib/std -I $pwd/lib/sys `$pwd/sysselect.sh config`
echo 	$pwd/6/6.out	-I $pwd/lib/regex -I $pwd/lib/bio -I $pwd/lib/std -I $pwd/lib/sys opts.myr ;	$pwd/6/6.out	-I $pwd/lib/regex -I $pwd/lib/bio -I $pwd/lib/std -I $pwd/lib/sys opts.myr 
echo 	$pwd/6/6.out	-I $pwd/lib/regex -I $pwd/lib/bio -I $pwd/lib/std -I $pwd/lib/sys types.myr ;	$pwd/6/6.out	-I $pwd/lib/regex -I $pwd/lib/bio -I $pwd/lib/std -I $pwd/lib/sys types.myr 
echo 	$pwd/6/6.out	-I $pwd/lib/regex -I $pwd/lib/bio -I $pwd/lib/std -I $pwd/lib/sys util.myr ;	$pwd/6/6.out	-I $pwd/lib/regex -I $pwd/lib/bio -I $pwd/lib/std -I $pwd/lib/sys util.myr 
echo 	$pwd/6/6.out	-I $pwd/lib/regex -I $pwd/lib/bio -I $pwd/lib/std -I $pwd/lib/sys deps.myr ;	$pwd/6/6.out	-I $pwd/lib/regex -I $pwd/lib/bio -I $pwd/lib/std -I $pwd/lib/sys deps.myr 
echo 	$pwd/6/6.out	-I $pwd/lib/regex -I $pwd/lib/bio -I $pwd/lib/std -I $pwd/lib/sys syssel.myr ;	$pwd/6/6.out	-I $pwd/lib/regex -I $pwd/lib/bio -I $pwd/lib/std -I $pwd/lib/sys syssel.myr 
echo 	$pwd/6/6.out	-I $pwd/lib/regex -I $pwd/lib/bio -I $pwd/lib/std -I $pwd/lib/sys parse.myr ;	$pwd/6/6.out	-I $pwd/lib/regex -I $pwd/lib/bio -I $pwd/lib/std -I $pwd/lib/sys parse.myr 
echo 	$pwd/6/6.out	-I $pwd/lib/regex -I $pwd/lib/bio -I $pwd/lib/std -I $pwd/lib/sys build.myr ;	$pwd/6/6.out	-I $pwd/lib/regex -I $pwd/lib/bio -I $pwd/lib/std -I $pwd/lib/sys build.myr 
echo 	$pwd/6/6.out	-I $pwd/lib/regex -I $pwd/lib/bio -I $pwd/lib/std -I $pwd/lib/sys install.myr ;	$pwd/6/6.out	-I $pwd/lib/regex -I $pwd/lib/bio -I $pwd/lib/std -I $pwd/lib/sys install.myr 
echo 	$pwd/6/6.out	-I $pwd/lib/regex -I $pwd/lib/bio -I $pwd/lib/std -I $pwd/lib/sys clean.myr ;	$pwd/6/6.out	-I $pwd/lib/regex -I $pwd/lib/bio -I $pwd/lib/std -I $pwd/lib/sys clean.myr 
echo 	$pwd/6/6.out	-I $pwd/lib/regex -I $pwd/lib/bio -I $pwd/lib/std -I $pwd/lib/sys test.myr ;	$pwd/6/6.out	-I $pwd/lib/regex -I $pwd/lib/bio -I $pwd/lib/std -I $pwd/lib/sys test.myr 
echo 	$pwd/6/6.out	-I $pwd/lib/regex -I $pwd/lib/bio -I $pwd/lib/std -I $pwd/lib/sys main.myr ;	$pwd/6/6.out	-I $pwd/lib/regex -I $pwd/lib/bio -I $pwd/lib/std -I $pwd/lib/sys main.myr 
echo 	6l	-lo mbld $pwd/rt/_myrrt.6 clean.6 types.6 deps.6 syssel.6 util.6 parse.6 main.6 build.6 opts.6 config.6 install.6 test.6 $pwd/lib/regex/libregex.a $pwd/lib/bio/libbio.a $pwd/lib/std/libstd.a $pwd/lib/sys/libsys.a ;	6l	-lo mbld $pwd/rt/_myrrt.6 clean.6 types.6 deps.6 syssel.6 util.6 parse.6 main.6 build.6 opts.6 config.6 install.6 test.6 $pwd/lib/regex/libregex.a $pwd/lib/bio/libbio.a $pwd/lib/std/libstd.a $pwd/lib/sys/libsys.a 
