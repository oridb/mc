...
echo 	ar	u libsys.a sys.6 ifreq.6 systypes.6 syscall.6 util.6  && 	ar	u libsys.a sys.6 ifreq.6 systypes.6 syscall.6 util.6  &&\
...
echo 	$pwd/6/6.out	-I ../sys -I . fltparse.myr  && 	$pwd/6/6.out	-I ../sys -I . fltparse.myr  &&\
...
echo 	$pwd/6/6.out	-I ../sys -I . netaddr.myr  && 	$pwd/6/6.out	-I ../sys -I . netaddr.myr  &&\
...
echo 	ar	u libregex.a interp.6 types.6 compile.6 ranges.6  && 	ar	u libregex.a interp.6 types.6 compile.6 ranges.6  &&\
...
echo 	$pwd/6/6.out	-I ../sys -I ../std mem.myr  && 	$pwd/6/6.out	-I ../sys -I ../std mem.myr  &&\
echo 	$pwd/6/6.out	-I ../sys -I ../std geti.myr  && 	$pwd/6/6.out	-I ../sys -I ../std geti.myr  &&\
echo 	$pwd/muse/6.out	-o libbio.use -p bio puti.use bio.use mem.use geti.use iter.use  && 	$pwd/muse/6.out	-o libbio.use -p bio puti.use bio.use mem.use geti.use iter.use  &&\
echo 	ar	u libbio.a puti.6 bio.6 mem.6 geti.6 iter.6  && 	ar	u libbio.a puti.6 bio.6 mem.6 geti.6 iter.6  &&\
...
echo 	$pwd/6/6.out	-I ../lib/regex -I ../lib/bio -I ../lib/std -I ../lib/sys subtest.myr  && 	$pwd/6/6.out	-I ../lib/regex -I ../lib/bio -I ../lib/std -I ../lib/sys subtest.myr  &&\
...
echo 	6l	-lo mbld $pwd/rt/_myrrt.6 clean.6 types.6 deps.6 syssel.6 util.6 subtest.6 parse.6 main.6 build.6 opts.6 config.6 install.6 test.6 ../lib/regex/libregex.a ../lib/bio/libbio.a ../lib/std/libstd.a ../lib/sys/libsys.a  && 	6l	-lo mbld $pwd/rt/_myrrt.6 clean.6 types.6 deps.6 syssel.6 util.6 subtest.6 parse.6 main.6 build.6 opts.6 config.6 install.6 test.6 ../lib/regex/libregex.a ../lib/bio/libbio.a ../lib/std/libstd.a ../lib/sys/libsys.a  &&\
true
