...
set -x
	...
	as -g -o obj/lib/thread/exit.o lib/thread/exit+openbsd-x64.s
	...
	as -g -o obj/lib/sys/syscall.o lib/sys/syscall+openbsd-x64.s
	$pwd/6/6m -O obj lib/sys/ifreq+openbsd.myr
	...
	$pwd/6/6m -O obj -I obj/lib/sys -I obj/lib/std lib/thread/fsbase+openbsd.myr
	$pwd/6/6m -O obj -I obj/lib/sys lib/std/errno.myr
	$pwd/6/6m -O obj -I obj/lib/sys lib/std/pledge+openbsd.myr
	...
	$pwd/6/6m -O obj -I obj/lib/sys lib/std/syswrap-ss+openbsd.myr
	...
	$pwd/6/6m -O obj -I obj/lib/sys lib/std/dir+openbsd.myr
	...
	$pwd/6/6m -O obj -I obj/lib/sys -I obj/lib/std lib/thread/spawn+openbsd.myr
	$pwd/6/6m -O obj -I obj/lib/sys -I obj/lib/std lib/thread/ncpu+openbsd.myr
	$pwd/6/6m -O obj -I obj/lib/sys -I obj/lib/std lib/thread/atomic.myr
	$pwd/6/6m -O obj -I obj/lib/sys -I obj/lib/std lib/thread/futex+openbsd:6.2.myr
	...
	$pwd/6/6m -O obj -I obj/lib/sys -I obj/lib/std lib/thread/condvar+openbsd:6.2.myr
