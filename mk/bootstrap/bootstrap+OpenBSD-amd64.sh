...
set -x
	...
	$pwd/6/6m -I lib/sys lib/std/sjlj.myr
	...
	$pwd/6/6m -I lib/sys lib/std/syswrap-ss+openbsd.myr
	...
	$pwd/6/6m -I lib/sys lib/std/dir+openbsd.myr
	...
	ld -nopie -o mbld/mbld $pwd/rt/_myrrt.o mbld/deps.o mbld/main.o mbld/util.o mbld/libs.o mbld/syssel.o mbld/config.o mbld/opts.o mbld/subtest.o mbld/types.o mbld/test.o mbld/install.o mbld/parse.o mbld/build.o -Llib/thread -lthread -Llib/bio -lbio -Llib/regex -lregex -Llib/std -lstd -Llib/sys -lsys
true
